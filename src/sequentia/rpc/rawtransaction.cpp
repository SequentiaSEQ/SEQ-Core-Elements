                ...
                {"", RPCArg::Type::OBJ_USER_KEYS, RPCArg::Optional::OMITTED, "",
                    {
                        ...
                        {"asset", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "The asset tag for this output"},
                    },
                    },
                {"", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "",
                    {
                ...
                {"", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "",
                    {
                        ...
                        {"asset", RPCArg::Type::STR, RPCArg::Optional::NO, "The asset tag for the fee output"},
                    },
                    },
            },
            },
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    CMutableTransaction rawTx = ConstructTransaction(request.params[0], request.params[1], request.params[2], true, chainman.ActiveChain().Tip());
